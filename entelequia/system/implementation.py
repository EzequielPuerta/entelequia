...
class SystemState(ABC):
    def __init__(self, system: SystemImplementation) -> "SystemState":
...
class SystemImplementation(ABC):
    ...
    @abstractmethod
    def start_up_when_stopped(self):
        pass

    @abstractmethod
    def shut_down_when_started(self):
        pass
...
class SubsystemImplementation(SystemImplementation):
    def __init__(self) -> "SubsystemImplementation":
        super().__init__()
        self.be_orphan()
